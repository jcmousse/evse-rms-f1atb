...
// Modification UART MC pour affichage VE et gestion du modeAuto/manuel
//***************************************************
...
const char *ParaRouteurJS = R"====(
  ...
  function SetHautBas(){
      ...
      //S +="<div class='Bonglet2 Bheure' id='Bheure'><a href='/Heure'>Heure</a></div><div class='Bonglet2 Bcouleurs'><a href='/Couleurs'>Couleurs</a></div></div>"; // UART MC à mettre en commentaire
      S +="<div class='Bonglet2 Bheure' id='Bheure'><a href='/Heure'>Heure</a></div><div class='Bonglet2 Bcouleurs'><a href='/Couleurs'>Couleurs</a></div>"; // MC modif pour afficher Borne VE sur la même ligne
      S +="<div id='BborneVE' class='Bonglet2 BborneVE'><a href='/BorneVE'>Borne VE</a></div>"; // UART MC gestion des paramètres BorneVE
